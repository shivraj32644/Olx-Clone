...
export default function DescriptionInput({input,textAreaCount,isError,handleInputChange}){

  
    return (
      <FormControl isInvalid={isError}  mb="15px">
        <FormLabel fontSize="12px" mb="1px" >Description *</FormLabel>
        <Textarea resize="none" maxLength={4096} fontSize="12px" h="32px" name="description" borderRadius="2px" type='text' value={input} pr="55px" onChange={(e)=>{
            handleInputChange(e)
        }} />
